...
@Component({
  selector: 'app-form-new-educacion',
  templateUrl: './form-new-educacion.component.html',
  styleUrls: ['./form-new-educacion.component.css']
})
export class FormNewEducacionComponent implements OnInit {
  ...
  save(event: Event) {
    ...
    this.datosPortfolio.nuevaEducacion(value,this.id_per).subscribe(data =>{
